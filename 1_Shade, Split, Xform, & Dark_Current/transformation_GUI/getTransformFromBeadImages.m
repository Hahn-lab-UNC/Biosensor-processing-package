...
%     %%
%     dlg_title = 'Save the input image to a ".tif" file';
%     [file_name,path_name,filter] = uiputfile('*.tif',dlg_title,strcat('input'));
%     
%     if filter
%         % store old directory path and change to path of save file specified
%         old_dir = cd(path_name);
% 
%         imwrite(inputImage,file_name,'tif','Compression','none','WriteMode','append');
% 
%         % switch to old directory
%         cd(old_dir);
%     end
%     
%     dlg_title = 'Save the base image to a ".tif" file';
%     [file_name,path_name,filter] = uiputfile('*.tif',dlg_title,strcat('base'));
%     
%     if filter
%         % store old directory path and change to path of save file specified
%         old_dir = cd(path_name);
% 
%         imwrite(baseImage,file_name,'tif','Compression','none','WriteMode','append');
% 
%         % switch to old directory
%         cd(old_dir);
%     end
%     
%     dlg_title = 'Save the transformed input image to a ".tif" file';
%     [file_name,path_name,filter] = uiputfile('*.tif',dlg_title,strcat('xIn'));
%     
%     if filter
%         % store old directory path and change to path of save file specified
%         old_dir = cd(path_name);
% 
%         imwrite(xIn,file_name,'tif','Compression','none','WriteMode','append');
% 
%         % switch to old directory
%         cd(old_dir);
%     end
%     %%
    ...
    imwrite(xIn, 'xIn.tif', 'Compression', 'none', 'WriteMode', 'append')
    imwrite(baseImage, 'base.tif', 'Compression', 'none', 'WriteMode', 'append')
